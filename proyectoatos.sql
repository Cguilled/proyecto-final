...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-08-2018 a las 09:53:02
...
ALTER TABLE `usuarios`
  ADD PRIMARY KEY (`ID_USUARIO`,`DAS`);
...
--
ALTER TABLE `roles`
  MODIFY `CODIGO_ROL` tinyint(2) NOT NULL AUTO_INCREMENT;
